...
const { createDefaultAdmin } = require('./Authentication/adminController');
const app = express();

// --------------------
// Webhook RAW Parser (must come before JSON parser)
// --------------------
...
mongoose
  ...
  .then(async () => {
    ...
    // Ensure default admin is created only after DB is ready
